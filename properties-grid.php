...
<ul class="list-unstyled mb-0">
<li><span class="feature">pods:</span><span class="feature-num"><?php echo $row['Bedrooms'];?></span></li>
...
<?php } ?>
                            ...
                            <span aria-hidden="true"><i class="fa fa-angle-right"></i></span>
                              ...
                              <div class="col-xs-12 col-sm-12 col-md-12 text-center mt-50">
                                     ...
                                     <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
                                         <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>">3</a>
                                     </li>
                                     <!-- <li><a href="?pageno="php">..</a></li> -->
                                     <li>
                                        <a href="?pageno=<?php echo $total_pages; ?>" aria-label="Next">
                            <span aria-hidden="true"><i class="fa fa-angle-right"></i></span>
                         </a>
                                    </li>
                                 </ul>
        ...
        <!-- cta #1
============================================= -->
<?php include_once('includes/tst.php');?>
============================================= -->
