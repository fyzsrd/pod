                        ...
                        <div class="widget widget-request">
                            ...
                            <div class="widget--content">
                                <form class="mb-0" method="post">
                                    ...
                                    <button type="button" class="btn-popup btn btn--primary btn--block" data-toggle="modal" data-target="#signupModule" >login to send inquiry</button>
                                </form>
                            </div>
                        </div>
                        <!-- . widget request end -->
...
============================================= -->
        <section id="cta" class="cta cta-1 text-center bg-overlay bg-overlay-dark pt-90">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                        <h3>Join our professional team & agents to start Capsule Hotel</h3>
